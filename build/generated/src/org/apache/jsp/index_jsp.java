...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 ArrayList<Category> arrloai = CategoryDAO.getCategory();
      ...
      out.write("\t\t\t\t\t\t<h3>Your dream bike.\n");
      out.write("\t\t\t\t\t\t\t<br />No Limits.</h3>\n");
      out.write("\t\t\t\t\t\t<p>Getting your bike readily assembled up to your doorstep or having it assembled according to your ideas at your local bike shop, it’s your choice. You will find the necessary tools, at good prices here at Bike-Discount.de! We supply bicycles from top-brands like Fuji, Cube, Merida, Felt and Radon.\n");
      out.write("                                                    To configure your personal dream bike you will find a big selection of parts and tools.</p>\n");
      ...
      out.write("\t\t\t\t<div class=\"col-lg-6\">\n");
      out.write("\t\t\t\t\t<div class=\"hot_deal_box\">\n");
      out.write("\t\t\t\t\t\t<img class=\"img-fluid\" src=\"img/product/hot_deals/deal2.jpg\" alt=\"\">\n");
      out.write("\t\t\t\t\t\t<div class=\"content\">\n");
      out.write("\t\t\t\t\t\t\t<h2>Hot Deals of this Month</h2>\n");
      out.write("\t\t\t\t\t\t\t<p>shop now</p>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\">\n");
      out.write("\t\t\t\t\t\t\t\t<h4>Trek Roscoe 8</h4>\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t<h5>$6000.00</h5>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\">\n");
      out.write("\t\t\t\t\t\t\t\t<h4>Trek Precaliber</h4>\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t<h5>$15000.00</h5>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\">\n");
      out.write("\t\t\t\t\t\t\t\t<h4>GT Stomper Prime</h4>\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t<h5>$3000.00</h5>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\">\n");
      out.write("\t\t\t\t\t\t\t\t<h4>Cannondale Slice CRB 105</h4>\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t<h5>$9000.00</h5>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\">\n");
      out.write("\t\t\t\t\t\t\t\t<h4>Giro Aerohead Mips</h4>\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
